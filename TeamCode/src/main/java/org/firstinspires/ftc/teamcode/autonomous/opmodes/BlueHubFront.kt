...
@Autonomous(group = "Blue", name = "Blue Hub Front")
class BlueHubFront: LinearOpMode() {
    override fun runOpMode() {
        Constants.opMode = this
        Constants.color = Constants.Color.BLUE
        Constants.startPose = TrajectoryFactory.hubFrontStartPose
        ...
        CommandScheduler.commands += AutoRoutines.hubFrontRoutine
