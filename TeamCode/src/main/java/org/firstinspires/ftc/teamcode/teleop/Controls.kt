...
object Controls {
    ...
    fun registerCommands() {
        ...
        gamepad1.rightBumper.pressed.command = { OdometryServo.switch }
        gamepad1.leftBumper.pressed.command = { CapArm.switch }
        ...
        gamepad2.a.pressed.command = { BucketLock.close }
        gamepad2.b.pressed.command = { BucketLock.open }
        gamepad2.leftBumper.pressed.command = { Carousel.fullRotation }
        gamepad2.rightBumper.pressed.command = { Carousel.fullRotationReverse }
    }
}