...
object TrajectoryFactory {
    ...
    fun initializeStartPositions() {
        ...
        teleOpAutomaticDepositPosition = Pose2d(8.0, 65.5.switchColor, 0.0)
    ...
    fun initializeTrioTrajectories() {
        startToInsideWarehouse = MecanumDrive.trajectoryBuilder(outsideWarehouseStartPose, 0.0.toRadians)
            .lineToConstantHeading(Vector2d(38.0, 66.0))
            .build()
        insideWarehouseToOutsideWarehouse = MecanumDrive.trajectoryBuilder(startToInsideWarehouse.trajectory.end() - Pose2d(0.0, 1.5, 0.0), 0.0.toRadians)
            .lineToConstantHeading(Vector2d(12.0, 66.0))
            .build()
        ...
        carouselToHubBottom = if (Constants.color == Constants.Color.BLUE)
            MecanumDrive.trajectoryBuilder(startToCarousel.trajectory.end(), startToCarousel.trajectory.end().heading + 180.0.toRadians)
                .splineToSplineHeading(Pose2d(-32.0, 24.0.switchColor, 180.0.switchColorAngle.toRadians), 320.0.switchColorAngle.toRadians)
                .build()
        else
