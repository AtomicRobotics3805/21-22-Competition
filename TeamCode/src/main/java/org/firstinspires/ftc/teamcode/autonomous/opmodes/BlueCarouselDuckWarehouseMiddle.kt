...
@Autonomous(group = "Blue", name = "Blue Carousel Duck Warehouse Middle")
//@Disabled
class BlueCarouselDuckWarehouseMiddle: LinearOpMode() {
    override fun runOpMode() {
        ...
        CommandScheduler.commandsToSchedule += sequential {
            ...
            +AutoRoutines.carouselHubBottomDuckWarehouseMiddleRoutine
        }
